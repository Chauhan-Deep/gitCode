...
export const LANG_ES_ES_TRANS = {
    ...
    'qxAdvantage': 'Guardar 10% con QuarkXPress Advantage.',
    ...
    'evalTextOnline': 'El periodo de evaluación para esta copia de QuarkXPress ha expirado.',
    'buy': 'Comprar ahora',
    'activate': 'Activar licencia',
    'coupon': 'Cupón: QXPTRIAL10',
